...
Whilestmt : WHILE '(' expr ')' DO Slist endwhile EOL		{$$=createTree(-1,-1,NULL,tWHILE,$3,$6,NULL);}
	;
expr : expr PLUS expr		{$$ = createTree(-1,-1,NULL,tADD,$1,$3,NULL);}
	 | expr MINUS expr  	{$$ = createTree(-1,-1,NULL,tSUB,$1,$3,NULL);}
	 | expr MUL expr	{$$ = createTree(-1,-1,NULL,tMUL,$1,$3,NULL);}
	 | expr DIV expr	{$$ = createTree(-1,-1,NULL,tDIV,$1,$3,NULL);}
	 | '(' expr ')'	{$$ = $2;}
