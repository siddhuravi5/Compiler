...
struct Classtable* Cinstall(char*name){
...
int codeGen(FILE* fp, struct tnode* root){
	int r,s,t1,regcount[20],regptr=-1,sourceReg,destReg,varAddr,label_1,label_2,label_3;
	char* varName;
	char* string;
	struct Lsymbol* ptr;
	struct Gsymbol* tmp;
	...
	int argArray[25];
	int argArrayInd=-1;
	struct Memberfunclist * mf1;
	struct Classtable* ctype1,*c1;
